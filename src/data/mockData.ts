...
export const mockClassrooms: Classroom[] = [
    ...
    { id: "F-202", name: "F-202", building: "フォーサイト", capacity: 285, examCapacity: 165, type: "normal", isMovable: false, equipment: ["PJ(中)", "モニター", "BD", "マイク", "黒板", "ブラインド"] },
    ...
    { id: "F-302", name: "F-302", building: "フォーサイト", capacity: 361, examCapacity: 209, type: "normal", isMovable: false, equipment: ["PJ(横)", "モニター", "BD", "マイク", "白板", "ブラインド"] },
    ...
    { id: "3-201", name: "3-201", building: "3号館", capacity: 342, examCapacity: 171, type: "normal", isMovable: false, equipment: ["PJ(横)", "モニター", "BD", "マイク", "ブラインド"] },
    ...
    const samples: Subject[] = [
        {
            ...
            requiredEquipment: ['PJ(中)', 'モニター', 'BD'],
