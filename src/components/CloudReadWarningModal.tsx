...
export const CloudReadWarningModal = ({ isOpen, summary, onConfirm, onCancel }: Props) => {
        ...
        >
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
              ...
              <h2 style={{ margin: 0, fontSize: '1.05rem' }}>クラウドの内容でローカルを上書きしますか？</h2>
            </div>
            <div style={{ fontSize: '0.82rem', color: '#64748b' }}>
              クラウド→ローカルに取得すると、現在のローカルデータは置き換わります。
            </div>
          </div>
          <button
            onClick={onCancel}
